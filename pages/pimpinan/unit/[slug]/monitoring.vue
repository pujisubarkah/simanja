<template>
  <div class="max-w-6xl mx-auto py-8">
    <h1 class="text-2xl font-bold mb-6">Monitoring Kegiatan Unit</h1>
          ...
          <table class="table table-zebra table-bordered w-full border-collapse">
            ...
            <tbody>
              ...
              <tr v-if="filteredKegiatan.length === 0">
                <td colspan="6" class="text-center text-gray-400">Tidak ada kegiatan</td>
              </tr>
            </tbody>
          </table>
        </div>
...
const detailKegiatan = ref<Kegiatan>({
  id: 0,
  nama: '',
  ketua: '',
  anggota: [],
